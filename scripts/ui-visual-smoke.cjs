...
const cases = [
  ...
  ...["settings", "graphite", "midnight", "cyberpunk"].map(theme => ({ name: `design-${theme}`, tab: "chat", fixture: `design-${theme}`, expect: { settingsOpen: true, appearanceVisible: true, designChoices: 4, designTheme: theme === "settings" ? "aurora" : theme } })),
  { name: "design-compact", tab: "chat", fixture: "design-settings", width: 360, height: 360, expect: { settingsOpen: true, appearanceVisible: true, designChoices: 4, titlebarOverlap: false } },
  ...
  { name: "goal-collapsed", tab: "chat", fixture: "goal-collapsed", expect: { goalChevronPointsUp: true, goalDockVisible: true, goalDockOpen: false, goalPhase: "active", goalDockBelowComposer: true, goalStripPinnedToBottom: true, goalStripHeight: 18, goalStripTextFree: true, goalRounds: "4/12", goalTrackFill: "33%", goalTrackHeight: 6 } },
