...
const cases = [
  ...
  { name: "goal-expanded", tab: "chat", fixture: "goal-expanded", expect: { goalDockVisible: true, goalDockOpen: true, goalActionCount: 3, goalPauseResumeLabel: "Pause", goalDockBelowComposer: true, goalStripPinnedToBottom: true, goalStripHeight: 18, goalStripTextFree: true, goalActionMinSize: 29, goalTrackHeight: 6 } },
  { name: "goal-paused", tab: "chat", fixture: "goal-paused", expect: { goalDockVisible: true, goalPhase: "paused", goalPauseResumeLabel: "Resume", goalDockBelowComposer: true } },
