...
const cases = [
  ...
  { name: "chat", tab: "chat", fixture: "chat", expect: { composerRestingHeight: 50, historicalReasoning: 0, markdownLists: 1, footer: 0, titlebarTabs: 1, titlebarOverlap: false, setupInToolbar: true, brandUserSelect: "none", composerUtilitiesInRow: true, composerViewInRow: true, contextRingSize: 18, sendWidth: 38, sendHeight: 38, contextCenterDelta: 0 } },
  { name: "focus-chat", tab: "chat", fixture: "focus-chat", width: 360, height: 500, expect: { focusMode: true, focusChromeHidden: true, historicalReasoning: 0, composerUtilitiesInRow: true, composerViewInRow: true, contextRingSize: 18, sendWidth: 36, sendHeight: 36, contextCenterDelta: 0 } },
  ...
  { name: "attachments", tab: "chat", fixture: "attachments", expect: { attachmentChips: 2, attachmentImages: 2, attachmentsAboveComposer: true, composerUtilitiesInRow: true } },
  { name: "compact-attachments", tab: "chat", fixture: "attachments", width: 360, height: 500, expect: { attachmentChips: 2, attachmentImages: 2, attachmentsAboveComposer: true, composerUtilitiesInRow: true } },
  ...
  { name: "compact-chat", tab: "chat", fixture: "chat", width: 360, height: 500, expect: { historicalReasoning: 0, footer: 0, titlebarTabs: 1, setupInToolbar: true, composerUtilitiesInRow: true, contextRingSize: 18, sendWidth: 36, sendHeight: 36 } },
  { name: "compact-tools", tab: "chat", fixture: "markdown-tools", width: 360, height: 500, expect: { toolGroups: 1, toolCalls: 2 } },
  { name: "composer-single-line", tab: "chat", fixture: "composer-single-line", width: 380, height: 400, expect: { composerInputHeight: 34, composerUtilityHeight: 24, composerInputScrollable: false, conversationBubbles: 1, shortMessageVisible: true }, max: { composerHeight: 60 } },
  ...
  { name: "small-chat-400", tab: "chat", fixture: "small-chat", width: 400, height: 400, expect: { composerInputHeight: 34, composerUtilityHeight: 24, conversationBubbles: 1, shortMessageVisible: true }, max: { composerHeight: 60 } },
  { name: "small-chat-380", tab: "chat", fixture: "small-chat", width: 380, height: 380, expect: { composerInputHeight: 34, composerUtilityHeight: 24, conversationBubbles: 1, shortMessageVisible: true }, max: { composerHeight: 60 } },
  { name: "small-chat-360", tab: "chat", fixture: "small-chat", width: 360, height: 360, expect: { composerInputHeight: 34, composerUtilityHeight: 24, conversationBubbles: 1, shortMessageVisible: true, titlebarOverlap: false }, max: { composerHeight: 60 } },
