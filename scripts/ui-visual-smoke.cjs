...
const cases = [
  ...
  { name: "goal-collapsed", tab: "chat", fixture: "goal-collapsed", expect: { goalChevronPointsUp: true, goalDockVisible: true, goalDockOpen: false, goalPhase: "active", goalDockBelowComposer: true, goalStripPinnedToBottom: true, goalStripHeight: 14, goalStripTextFree: true, goalRounds: "4/12", goalTrackFill: "33%", goalTrackHeight: 3 } },
