...
const cases = [
  ...
  { name: "goal-collapsed", tab: "chat", fixture: "goal-collapsed", expect: { goalDockVisible: true, goalDockOpen: false, goalPhase: "active", goalDockBelowComposer: true, goalStripPinnedToBottom: true, goalStripHeight: 18, goalStripTextFree: true, goalRounds: "4/12", goalTrackFill: "33%", goalTrackHeight: 6 } },
  { name: "goal-expanded", tab: "chat", fixture: "goal-expanded", expect: { goalDockVisible: true, goalDockOpen: true, goalActionCount: 2, goalPauseAction: "Pause the goal", goalStripPauseSize: 18, goalStripPauseGlyph: "#icon-pause", goalDockBelowComposer: true, goalStripPinnedToBottom: true, goalStripHeight: 18, goalStripTextFree: true, goalActionMinSize: 28, goalTrackHeight: 6 } },
