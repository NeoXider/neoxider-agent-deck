...
<p align="center">
  ...
  <img alt="Source version" src="https://img.shields.io/badge/source-v0.9.5-8b79ff" />
  <a href="CHANGELOG.md"><img alt="Changelog" src="https://img.shields.io/badge/changelog-0.9.5-49e7c6" /></a>
...
The portable executable is written to `release/NeoXider-Agent-Deck-0.9.5-windows-x64-portable.exe`.
...
Every release is documented in [CHANGELOG.md](CHANGELOG.md). Source version 0.9.5 adds device approval for Wi-Fi access, fixes authenticated opening from the tray and hotkey, and shows full-context compaction estimates when history supports them.
