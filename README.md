...
<p align="center">
  ...
  <img alt="Source version" src="https://img.shields.io/badge/source-v0.9.4-8b79ff" />
  <a href="CHANGELOG.md"><img alt="Changelog" src="https://img.shields.io/badge/changelog-0.9.4-49e7c6" /></a>
...
The portable executable is written to `release/NeoXider-Agent-Deck-0.9.4-windows-x64-portable.exe`.
...
Every release is documented in [CHANGELOG.md](CHANGELOG.md). Source version 0.9.4 repairs initial loading of large live conversations, preserves reading position across compact modes, and keeps message and input tooltips above the widget. Attachment previews and context compaction markers remain available in the conversation. Compaction counts are explicitly approximate when Harness provides estimates of the replaced context.
