...
<p align="center">
  ...
  <img alt="Source version" src="https://img.shields.io/badge/source-v0.7.5-8b79ff" />
  <a href="CHANGELOG.md"><img alt="Changelog" src="https://img.shields.io/badge/changelog-0.7.5-49e7c6" /></a>
...
The portable executable is written to `release/NeoXider-Agent-Deck-0.7.5-windows-x64-portable.exe`.
...
Every release is documented in [CHANGELOG.md](CHANGELOG.md). Source version 0.7.5 keeps long chats responsive with 80-message history pages, background Markdown formatting and unchanged-history reuse. It restores the last opened chat when the app starts or Harness reconnects, and shows the exact subagent total alongside the running count. Older messages remain available through the history navigation controls.
