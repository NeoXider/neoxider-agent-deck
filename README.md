...
<p align="center">
  ...
  <img alt="Source version" src="https://img.shields.io/badge/source-v0.6.14-8b79ff" />
  <a href="CHANGELOG.md"><img alt="Changelog" src="https://img.shields.io/badge/changelog-0.6.14-49e7c6" /></a>
...
The portable executable is written to `release/NeoXider-Agent-Deck-0.6.14-windows-x64-portable.exe`.
...
Every release is documented in [CHANGELOG.md](CHANGELOG.md). The current release, 0.6.14,
