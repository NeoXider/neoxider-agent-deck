...
<p align="center">
  ...
  <img alt="Source version" src="https://img.shields.io/badge/source-v0.7.6-8b79ff" />
  <a href="CHANGELOG.md"><img alt="Changelog" src="https://img.shields.io/badge/changelog-0.7.6-49e7c6" /></a>
...
The portable executable is written to `release/NeoXider-Agent-Deck-0.7.6-windows-x64-portable.exe`.
...
Every release is documented in [CHANGELOG.md](CHANGELOG.md). Source version 0.7.6 keeps the widget working across Harness generations: the readiness probe accepts the token-gated browser index as up, and opening Harness from the widget carries the owned launch token so the browser lands authenticated.
