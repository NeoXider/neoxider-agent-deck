...
<p align="center">
  ...
  <img alt="Source version" src="https://img.shields.io/badge/source-v0.5.1-8b79ff" />
  <a href="CHANGELOG.md"><img alt="Changelog" src="https://img.shields.io/badge/changelog-0.5.1-49e7c6" /></a>
...
The portable executable is written to `release/NeoXider-Agent-Deck-0.5.1-windows-x64-portable.exe`.
...
Every release is documented in [CHANGELOG.md](CHANGELOG.md). The current release, 0.5.1,
keeps the 0.5.0 UI, screenshots, hotkeys, updater, session-safe rendering and compact
placement while correcting live Windows startup-path migration after a portable move.
