...
<p align="center">
  ...
  <img alt="Source version" src="https://img.shields.io/badge/source-v0.9.3-8b79ff" />
  <a href="CHANGELOG.md"><img alt="Changelog" src="https://img.shields.io/badge/changelog-0.9.3-49e7c6" /></a>
...
The portable executable is written to `release/NeoXider-Agent-Deck-0.9.3-windows-x64-portable.exe`.
...
Every release is documented in [CHANGELOG.md](CHANGELOG.md). Source version 0.9.3 fixes blank transcript regions and unwanted scrolling, keeps attachment previews visible in small windows, and marks context compaction at its position in the conversation. Compaction counts are explicitly approximate when Harness provides estimates of the replaced context.
