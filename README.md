...
<p align="center">
  <img alt="Source version" src="https://img.shields.io/badge/source-v0.9.11-49e7c6" />
  <a href="CHANGELOG.md"><img alt="Changelog" src="https://img.shields.io/badge/changelog-0.9.11-8b79ff" /></a>
...
1. Download the installer or `NeoXider-Agent-Deck-0.9.11-windows-x64-portable.exe` from [Releases](https://github.com/NeoXider/neoxider-agent-deck/releases/latest).
...
Set `DSH_WIDGET_URL` for a different Harness endpoint. Source version 0.9.11 includes unified effort controls, themed motion and the Windows private overlay.
