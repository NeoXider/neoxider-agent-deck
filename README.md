...
<p align="center">
  ...
  <img alt="Source version" src="https://img.shields.io/badge/source-v0.7.4-8b79ff" />
  <a href="CHANGELOG.md"><img alt="Changelog" src="https://img.shields.io/badge/changelog-0.7.4-49e7c6" /></a>
...
The portable executable is written to `release/NeoXider-Agent-Deck-0.7.4-windows-x64-portable.exe`.
...
Every release is documented in [CHANGELOG.md](CHANGELOG.md). Source version 0.7.4 restores
publishable builds: the release validation job had been failing the high-severity `npm audit`
gate, so 0.7.3 never published and installed 0.7.2 builds had no update to find. It also removes
the native "Restore widget" tooltip that the Edge line and the Orb popped over a running game, on
top of the 0.7.2 Windows startup readback fix and the selected-chat activity light, unified
